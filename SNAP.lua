...
local Window = Library.CreateLib("SNAP - v1.0.7S", "DarkTheme")
...
local CreditsTab = Windows:NewTab("Credits")
local CreditsSection = ColorTab:NewSection("Credits")
...
BindsSection:NewKeybind("Toggle UI", "", Enum.KeyCode.`, function()
	Library:ToggleUI()
end)

CreditsSection:NewLabel("Made By Payson Holmes")
CreditsSection:NewLabel("youtube.com/P-Denny")
CreditsSection:NewLabel("twitch.tv/paysonism")
